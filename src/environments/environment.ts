...
export const environment = {
  production: false,
  //  URL_CLOSE_SESSION: 'http://localhost:3001/cierreSesion',
  //  URL_CONSULTASERVICES: 'http://localhost:3001/consultanit',
  //  URL_CONSULTASALDO: 'http://localhost:3001/Consultasaldo',
